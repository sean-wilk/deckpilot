            ...
            {(analysis.land_count !== undefined ||
              ...
              <div className="space-y-3">
                ...
                {onSwitchToManaFixing && (
                  <button
                    type="button"
                    onClick={onSwitchToManaFixing}
                    className="flex items-center gap-1.5 text-xs text-interactive hover:text-interactive-hover transition-colors mt-2"
                  >
                    Deep dive into your lands
