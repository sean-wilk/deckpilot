...
export const adminAiConfig = pgTable("admin_ai_config", {
  ...
  maxTokensAnalysis: integer("max_tokens_analysis").default(8192).notNull(),
  maxTokensRecommendations: integer("max_tokens_recommendations").default(8192).notNull(),
  maxTokensChat: integer("max_tokens_chat").default(4096).notNull(),
  maxTokensGeneration: integer("max_tokens_generation").default(16384).notNull(),
